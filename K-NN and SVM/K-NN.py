...
print(k_neighbor.predict(sc.transform([[30,87000]])))
...
plt.contourf(x1, x2, k_neighbor.predict(sc.transform(np.array([x1.ravel(), x2.ravel()]).T)).reshape(x1.shape), alpha = 0.75, cmap = ListedColormap(('red','green')))
